...
/* ContractForge's real brand — visibly NOT the Cosmic Garden.
...
export default function S11_Proof() {
  return (
    ...
    >
      <PortalScene variant="proof" />

      {/* HUD annotations flanking the proof */}
      <HudPanel style={{ left: '3vw', top: '38vh' }}>
        {'CONTRACTFORGE // LIVE\n₹2,499/MO'}
      </HudPanel>
      <HudPanel style={{ right: '3vw', top: '46vh' }}>
        {'BUILT BY FORGEOS\ncontractforge.co.in →'}
      </HudPanel>
      ...
      <div className="relative mt-14 w-full max-w-3xl px-4 md:px-10">
        <div
          aria-hidden
        ...
        />
        <motion.div
          className="glass glass-warm relative p-4 md:p-6"
        ...
        <motion.p
          className="relative mt-6 text-center text-[13px]"
